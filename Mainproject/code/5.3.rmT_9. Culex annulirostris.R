...
alp_vec <- 2780 -235 *(T_vec-273.15)+4.7*(T_vec-273.15)^2

bpk_vec <-  -1260 + 109*(T_vec-273.15)-2.21* (T_vec-273.15)^2

z_vec <- 0.373 - 0.0292*(T_vec-273.15)+0.000634*(T_vec-273.15)^2
