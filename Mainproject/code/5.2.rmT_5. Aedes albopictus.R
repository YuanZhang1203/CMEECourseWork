...
alp_vec <- 119-7.49*(T_vec-273.15) +0.128*(T_vec-273.15)^2

bpk_vec <- -366+36*(T_vec-273.15) -0.686*(T_vec-273.15)^2

z_vec <- B_inv(B_0_z,E_z,E_D_z,T_vec,T_ref_par,T_pk_z+273.15,k_par)
...
legend(12,-0.05,c("Full","Juvenile traits constant","Adult traits constant"),
