...
alp_vec <- 189-10.6 *(T_vec-273.15)+0.162*(T_vec-273.15)^2

bpk_vec <-  -1080 + 91.4*(T_vec-273.15)-1.55* (T_vec-273.15)^2

z_vec <- 0.0565- 0.0042*(T_vec-273.15)+0.000119*(T_vec-273.15)^2
...
legend("bottomleft",c("Full","Juvenile traits constant","Adult traits constant"),
